...
/*
 ...
 MyFonts Webfont Build ID 2883926, 2014-09-15T21:55:38-0400
 ...
 Webfont: Lasiver Medium by Type Dynamic
 URL: http://www.myfonts.com/fonts/typedynamic/lasiver/medium/
 Copyright: Copyright &#x00A9; 2013 by Type Dynamic. All rights reserved.
 Licensed pageviews: 250,000


 License: http://www.myfonts.com/viewlicense?type=web&buildid=2883926

 ? 2014 MyFonts Inc
*/
var protocol=document.location.protocol;"https:"!=protocol&&(protocol="http:");var count=document.createElement("script");count.type="text/javascript";count.async=!0;count.src=protocol+"//hello.myfonts.net/count/2c0156";var s=document.getElementsByTagName("script")[0];s.parentNode.insertBefore(count,s);var browserName,browserVersion,webfontType;if("undefined"==typeof woffEnabled)var woffEnabled=!0;var svgEnabled=0;
...
for(var fonts=[{fontFamily:"Minion-Italic",url:wfpath+"2C0156_0"+suffix+"_0."+webfontType},{fontFamily:"BrandonGrotesque-Bold",url:wfpath+"2C0156_1"+suffix+"_0."+webfontType},{fontFamily:"BrandonGrotesque-Black",url:wfpath+"2C0156_2"+suffix+"_0."+webfontType},{fontFamily:"Lasiver-Light",url:wfpath+"2C0156_3"+suffix+"_0."+webfontType},{fontFamily:"Lasiver-Medium",url:wfpath+"2C0156_4"+suffix+"_0."+webfontType}],len=fonts.length,css="",i=0;i<len;i++){var format="svg#wf"==webfontType?'format("svg")':
